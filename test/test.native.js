...
tape( 'if provided a number greater than or equal to one for `x` and a finite `alpha` and `beta`, the function returns `0`', opts, function test( t ) {
...
tape( 'the function evaluates the logcdf for `x` given a large `alpha`', opts, function test( t ) {
	var expected;
	var alpha;
	var beta;
	var i;
...
tape( 'the function evaluates the logcdf for `x` given a large `beta`', opts, function test( t ) {
	var expected;
	var alpha;
	var beta;
	var i;
...
tape( 'the function evaluates the logcdf for `x` given a large `alpha` and `beta`', opts, function test( t ) {
	var expected;
	var alpha;
	var beta;
	var i;
